...
class Auction:
    def __init__(self,
        ...
        self.brief_client = threading.Thread(target=self.send_info_client)
    ...
    def send_info_client(self):
        while True:
            m = "@uction_data" + str({"hb": self.highest_bidder,
                                      "cb": self.current_bid,
                                      "ad": self.auction_done,
                                      "tl": self.time_left,
                                      "bi": self.bid_increment,
                                      'cd': self.clients
                                      })
